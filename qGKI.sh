...
#    make ${BUILD_OPTIONS} mrproper
    ...
    ./scripts/kconfig/merge_config.sh -O ${KERNEL_ROOT}/out arch/arm64/configs/vendor/a52sxq_eur_open_defconfig arch/arm64/configs/bbg.config arch/arm64/configs/nomount.config
